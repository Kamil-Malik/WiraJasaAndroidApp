...
data class SellerApplication(
    ...
    @get:PropertyName(SERVICE_DESCRIPTION) @set:PropertyName(SERVICE_DESCRIPTION)
    var serviceDescription: String = "",

    @get:PropertyName(PHOTO_ID)
    @set:PropertyName(PHOTO_ID)
    var photoID: String = "",

    @get:PropertyName(PROVINCE)
    @set:PropertyName(PROVINCE)
    var province: String = "",

    @get:PropertyName(APPLICATION_STATUS)
    @set:PropertyName(APPLICATION_STATUS)
    ...
    companion object {
        ...
        private const val SERVICE_DESCRIPTION = "service_description"
